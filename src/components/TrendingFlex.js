      ...
      <div className="flex gap-4 overflow-auto">
        {data.map((movie) => (
          <div
            ...
            overflow-hidden relative z-[0] md:min-w-[470px] md:h-[230px] duration-200 parent"
          >
            <div
              className="absolute z-[100] right-2 top-2 md:right-6 md:top-4 w-8 h-8 bg-dark-blue/50 rounded-full
            ...
            <div className="flex items-center gap-5 pl-4 md:pl-6 group">
